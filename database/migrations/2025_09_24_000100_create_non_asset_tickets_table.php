...
return new class extends Migration
{
    ...
    {
        Schema::create('non_asset_tickets', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('asset_name')->nullable(); // Input manual, bukan relasi
    ...
    {
        Schema::dropIfExists('non_asset_tickets');
    }
};
