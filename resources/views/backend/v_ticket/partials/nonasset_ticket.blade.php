<div class="card shadow-sm border-0">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="nonassetticket_table" class="table table-hover table-striped table-bordered align-middle">
...
document.addEventListener('DOMContentLoaded', function () {
    // Cek apakah tabel sudah ada & belum diinisialisasi
    const tableSelector = '#nonassetticket_table';
